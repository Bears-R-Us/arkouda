...
const vectors_sip128_raw: [0..#64][0..#16] int = [
    [
...
var vectors_sip64: [0..#64][0..#8] uint(8);
for i in 0..#64 {
  for j in 0..#8 {
    vectors_sip64[i][j] = vectors_sip64_raw[i][j]: uint(8);
  }
}

var vectors_sip128: [0..#64][0..#16] uint(8);
for i in 0..#64 {
  for j in 0..#16 {
    vectors_sip128[i][j] = vectors_sip128_raw[i][j]: uint(8);
  }
}
