...
def quantile(
    ...
    """
    if keepdims:
        raise ValueError("keepdims is not currently enabled in quantile/percentile.")
    ...
    # scalar q, with axis slicing
        ...
        # squeeze out the degenerate axis or axes
...
def percentile(
    ...
    For more detailed documentation, see ak.quantile
    """
