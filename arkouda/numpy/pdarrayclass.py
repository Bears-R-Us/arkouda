...
@typechecked
def allclose(
    a: pdarray, b: pdarray, rtol: float = 1e-5, atol: float = 1e-8, nan_equals: bool = False
) -> bool:
    """
    ...
    return bool(
        parse_single_value(
            generic_msg(
                ...
                args={"a": a, "b": b, "rtol": rtol, "atol": atol, "nan_equals": nan_equals},
            )
        )
    )
