...
def histogram2d(
    ...
    range: Optional[Tuple[Tuple[numeric_scalars, numeric_scalars],
                          Tuple[numeric_scalars, numeric_scalars]]] = None,
    ...
    repMsg = generic_msg(cmd="histogram2D", args={
        "x": x, "y": y, "xBins": x_bins, "yBins": y_bins,
