...
#       NOTE: The commented out code below can be replaced with a call to ak.transpose.
#       NOTE: Remove that code and these comments before requesting review.
...
#       return permute_dims(self, _axes)
    ...
    def __abs__(self: Array, /) -> Array:
        ...
        """
        return asarray(ak.abs(self._array))
