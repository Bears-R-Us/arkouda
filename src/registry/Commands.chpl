...
registerFunction('broadcast<uint8,1,1>', ark_broadcast_uint8_1_1, 'ManipulationMsg', 62);
...
registerFunction('concat<uint8,1>', ark_concat_uint8_1, 'ManipulationMsg', 159);
...
registerFunction('concatFlat<uint8,1>', ark_concatFlat_uint8_1, 'ManipulationMsg', 215);
...
registerFunction('expandDims<uint8,1>', ark_expandDims_uint8_1, 'ManipulationMsg', 239);
...
registerFunction('flip<uint8,1>', ark_flip_uint8_1, 'ManipulationMsg', 291);
...
registerFunction('flipAll<uint8,1>', ark_flipAll_uint8_1, 'ManipulationMsg', 359);
...
registerFunction('permuteDims<uint8,1>', ark_permuteDims_uint8_1, 'ManipulationMsg', 390);
...
registerFunction('reshape<uint8,1,1>', ark_reshape_uint8_1_1, 'ManipulationMsg', 440);
...
registerFunction('roll<uint8,1>', ark_roll_uint8_1, 'ManipulationMsg', 522);
...
registerFunction('rollFlattened<uint8,1>', ark_rollFlattened_uint8_1, 'ManipulationMsg', 587);
...
registerFunction('squeeze<uint8,1,1>', ark_squeeze_uint8_1_1, 'ManipulationMsg', 608);
...
registerFunction('stack<uint8,1>', ark_stack_uint8_1, 'ManipulationMsg', 687);
...
registerFunction('tile<uint8,1>', ark_tile_uint8_1, 'ManipulationMsg', 778);
...
registerFunction('unstack<uint8,1>', ark_unstack_uint8_1, 'ManipulationMsg', 819);
...
registerFunction('repeatFlat<uint8,1>', ark_repeatFlat_uint8_1, 'ManipulationMsg', 903);
...
registerFunction('mean<uint8,1>', ark_mean_uint8_1, 'StatsMsg', 25);
...
registerFunction('meanReduce<uint8,1>', ark_meanReduce_uint8_1, 'StatsMsg', 32);
...
registerFunction('var<uint8,1>', ark_var_uint8_1, 'StatsMsg', 43);
...
registerFunction('varReduce<uint8,1>', ark_varReduce_uint8_1, 'StatsMsg', 50);
...
registerFunction('std<uint8,1>', ark_std_uint8_1, 'StatsMsg', 61);
...
registerFunction('stdReduce<uint8,1>', ark_stdReduce_uint8_1, 'StatsMsg', 68);
...
registerFunction('cov<int64,1,uint8,1>', ark_cov_int_1_uint8_1, 'StatsMsg', 79);
...
registerFunction('cov<uint64,1,uint8,1>', ark_cov_uint_1_uint8_1, 'StatsMsg', 79);
...
registerFunction('cov<uint8,1,int64,1>', ark_cov_uint8_1_int_1, 'StatsMsg', 79);
...
registerFunction('cov<uint8,1,uint64,1>', ark_cov_uint8_1_uint_1, 'StatsMsg', 79);
...
registerFunction('cov<uint8,1,uint8,1>', ark_cov_uint8_1_uint8_1, 'StatsMsg', 79);
...
registerFunction('cov<uint8,1,float64,1>', ark_cov_uint8_1_real_1, 'StatsMsg', 79);
...
registerFunction('cov<uint8,1,bool,1>', ark_cov_uint8_1_bool_1, 'StatsMsg', 79);
...
registerFunction('cov<uint8,1,bigint,1>', ark_cov_uint8_1_bigint_1, 'StatsMsg', 79);
...
registerFunction('cov<float64,1,uint8,1>', ark_cov_real_1_uint8_1, 'StatsMsg', 79);
...
registerFunction('cov<bool,1,uint8,1>', ark_cov_bool_1_uint8_1, 'StatsMsg', 79);
...
registerFunction('cov<bigint,1,uint8,1>', ark_cov_bigint_1_uint8_1, 'StatsMsg', 79);
...
registerFunction('corr<int64,1,uint8,1>', ark_corr_int_1_uint8_1, 'StatsMsg', 101);
...
registerFunction('corr<uint64,1,uint8,1>', ark_corr_uint_1_uint8_1, 'StatsMsg', 101);
...
registerFunction('corr<uint8,1,int64,1>', ark_corr_uint8_1_int_1, 'StatsMsg', 101);
...
registerFunction('corr<uint8,1,uint64,1>', ark_corr_uint8_1_uint_1, 'StatsMsg', 101);
...
registerFunction('corr<uint8,1,uint8,1>', ark_corr_uint8_1_uint8_1, 'StatsMsg', 101);
...
registerFunction('corr<uint8,1,float64,1>', ark_corr_uint8_1_real_1, 'StatsMsg', 101);
...
registerFunction('corr<uint8,1,bool,1>', ark_corr_uint8_1_bool_1, 'StatsMsg', 101);
...
registerFunction('corr<uint8,1,bigint,1>', ark_corr_uint8_1_bigint_1, 'StatsMsg', 101);
...
registerFunction('corr<float64,1,uint8,1>', ark_corr_real_1_uint8_1, 'StatsMsg', 101);
...
registerFunction('corr<bool,1,uint8,1>', ark_corr_bool_1_uint8_1, 'StatsMsg', 101);
...
registerFunction('corr<bigint,1,uint8,1>', ark_corr_bigint_1_uint8_1, 'StatsMsg', 101);
...
registerFunction('cumSum<uint8,1>', ark_cumSum_uint8_1, 'StatsMsg', 123);
