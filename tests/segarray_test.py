...
class SegArrayTest(ArkoudaTest):
    ...
    def test_append(self):
        ...
        self.assertListEqual(appended[3].to_ndarray().tolist(), [1, 2, 3, 4])
        self.assertListEqual(appended[4].to_ndarray().tolist(), [22, 23])
        ...
        self.assertListEqual(appended[0].to_ndarray().tolist(), [1, 2, 10])
        self.assertListEqual(appended[1].to_ndarray().tolist(), [3, 4, 20])
    ...
    def test_single_append(self):
        ...
        self.assertListEqual(appended[1].to_ndarray().tolist(), b + [98])
        self.assertListEqual(appended[2].to_ndarray().tolist(), c + [97])
        ...
        self.assertListEqual(appended[2].to_ndarray().tolist(), c + [99])
        ...
        self.assertListEqual(appended[2].to_ndarray().tolist(), [99] + c)
    ...
    def test_remove_repeats(self):
        ...
        self.assertListEqual(dedup[1].to_ndarray().tolist(), list(set(b)))
