...
class TestArkoudaSeriesAccessorArgsort:
    def test_argsort_returns_arkoudaarray_and_matches_numpy_int(self):
        ...
        assert isinstance(perm, ArkoudaArray)
        assert np.array_equal(perm.to_ndarray(), np.array([1, 2, 0]))
    ...
    def test_argsort_descending(self):
        ...
        assert isinstance(perm, ArkoudaArray)
        assert np.array_equal(perm.to_ndarray(), np.array([0, 2, 1]))
    ...
    def test_argsort_float_nan_default_last(self):
        ...
        assert np.array_equal(perm.to_ndarray(), np.array([2, 0, 1]))
    ...
    def test_argsort_strings(self):
        ...
        assert isinstance(perm, ArkoudaArray)
        assert np.array_equal(perm.to_ndarray(), np.array([1, 0, 2]))
