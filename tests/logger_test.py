...
class TestLogger:
    ...
    def test_verbosity_controls(self):
        logger = get_arkouda_logger(name="VerboseLogger", logLevel=LogLevel("INFO"))
    ...
    def test_enable_disable_verbose(self):
        logger_one = get_arkouda_logger(name="logger_one", logLevel=LogLevel.INFO)
        logger_two = get_arkouda_logger(name="logger_two", logLevel=LogLevel.INFO)
    ...
    def test_error_handling(self):
        ...
        with pytest.raises(TypeError):
            logger.disable_verbose(logLevel="INFO")
