...
from arkouda.numpy.dtypes import dtype as akdtype, str_
...
class TestNumeric:
    ...
    def test_cumsum_and_cumprod_2D(self, num_type, axis_):
    ...
    def test_cumsum_and_cumprod_3D(self, num_type, axis_):
