...
def create_parser():
    ...
    parser.add_argument('-e', '--vedges', type=int, default=4,help='Number of edges per vertex')
    parser.add_argument('-p', '--possibility', type=float, default=0.3,help='Possibility ')
