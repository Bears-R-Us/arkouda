...
def create_parser():
    ...
    parser.add_argument(
        ...
        type=int,
        default=10**8,
        help="Problem size: length of index and scatter arrays",
    )
    parser.add_argument(
        "-i", "--index-size", type=int, help="Length of index array (number of scatters to perform)"
    )
    parser.add_argument(
        "-v", "--value-size", type=int, help="Length of array from which values are scattered"
    )
    parser.add_argument(
