...
def create_parser():
    parser = argparse.ArgumentParser(description="Run the dataframe display benchmarks: "
                                                 "_get_head_tail, _get_head_tail_server")
    parser.add_argument('hostname', help='Hostname of arkouda server')
    parser.add_argument('port', type=int, help='Port of arkouda server')
    parser.add_argument('-n', '--size', type=int, default=10**4, help='Problem size: length of columns in dataframe.')
