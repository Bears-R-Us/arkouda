...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Generates an rmat structured spare matrix as tuples(ii,jj)"
    )
    ...
    parser.add_argument(
        "--perm", default=False, action="store_true", help="permute vertex indices/names"
    )
    parser.add_argument("--pl", default=False, action="store_true", help="print layers in bfs")
    parser.add_argument(
        "--pc", default=False, action="store_true", help="print connected comp as they are found"
    )
