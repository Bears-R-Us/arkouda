...
def generate_alpha_string_array(
    string_length: int = 10, array_length: int = 100, uppercase: bool = False
) -> np.ndarray:
    """
    ...
    """
    return np.array(
        [generate_alpha_string(length=string_length, uppercase=uppercase) for _ in range(array_length)],
        dtype="str",
    )


def generate_alphanumeric_string_array(
    string_length: int = 10, array_length: int = 100, uppercase: bool = False
) -> np.ndarray:
    """
    ...
    return np.array(
        [
            generate_alphanumeric_string(length=string_length, uppercase=uppercase)
