...
ifdef ARKOUDA_SERVER_USER_MODULES
	ifeq (,$(findstring \-M,$(ARKOUDA_SERVER_USER_MODULES)))
		ARKOUDA_SERVER_USER_MODULES_CMD += -M $(ARKOUDA_SERVER_USER_MODULES)
	endif
endif
...
$(ARKOUDA_MAIN_MODULE): check-deps $(ARROW_O) $(ARKOUDA_SOURCES) $(ARKOUDA_MAKEFILES)
	...
	$(CHPL) $(CHPL_DEBUG_FLAGS) $(PRINT_PASSES_FLAGS) $(REGEX_MAX_CAPTURES_FLAG) $(OPTIONAL_SERVER_FLAGS) $(CHPL_FLAGS_WITH_VERSION) $(ARKOUDA_MAIN_SOURCE) $(ARKOUDA_COMPAT_MODULES) $(ARKOUDA_SERVER_USER_MODULES_CMD) -o $@
